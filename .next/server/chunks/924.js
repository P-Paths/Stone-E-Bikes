"use strict";exports.id=924,exports.ids=[924],exports.modules={21362:(a,b,c)=>{c.d(b,{X:()=>d});async function d(){try{return[{title:"The Top 5 Health Benefits of Cycling: Why Riding is Great for Your Body and Mind",slug:"cycling-health-benefits",date:"2024-01-20",excerpt:"Discover the science-backed health benefits of cycling, from cardiovascular fitness to mental well-being. Learn why riding a bike is one of the best exercises for overall health.",tags:["health","fitness","cycling","exercise","wellness","e-bikes"],content:`Cycling is more than just a fun way to get around—it's one of the most effective forms of exercise for improving your overall health. Whether you're riding a traditional bicycle or an electric bike, the benefits are numerous and well-documented.
