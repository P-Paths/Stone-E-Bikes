    ...
    <div className="bg-white w-full" style={{ minHeight: 'calc(100vh - 200px)' }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16">
        <div className="text-center">
          <h1 className="text-4xl lg:text-6xl font-bold mb-6" style={{ color: '#004225' }}>
            Stone E-Bikes
          </h1>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-2xl font-bold mb-4" style={{ color: '#004225' }}>Innovation</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4" style={{ color: '#004225' }}>Detroit Roots</h2>
            <p style={{ color: '#6B7280' }}>
          ...
          <div>
            <h2 className="text-2xl font-bold mb-4" style={{ color: '#004225' }}>Partnership</h2>
            <p style={{ color: '#6B7280' }}>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl lg:text-4xl font-bold mb-6" style={{ color: '#004225' }}>Our Mission</h2>
