  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <h1 className="text-4xl lg:text-5xl font-bold mb-8" style={{ color: '#000000' }}>Partnerships & Pilot Opportunities</h1>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-bold mb-6" style={{ color: '#000000' }}>Partnership Opportunities</h2>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-bold mb-6" style={{ color: '#000000' }}>Pilot Programs</h2>
          <div className="space-y-4 text-lg" style={{ color: '#6B7280' }}>
            <p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="max-w-3xl">
          <h2 className="text-3xl font-bold mb-6" style={{ color: '#000000' }}>Investment Opportunities</h2>
          <div className="space-y-4 text-lg" style={{ color: '#6B7280' }}>
            <p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h2 className="text-2xl font-bold mb-4" style={{ color: '#000000' }}>Let's Build the Future Together</h2>
